...
#     NO_META => q[1]
#     PL_FILES => {  }
#     PREREQ_PM => { Catalyst::View::TT=>q[0], parent=>q[0], DBD::SQLite=>q[0], Catalyst::Request::Upload=>q[0], Catalyst::Plugin::Static::Simple=>q[0], Catalyst::Plugin::ConfigLoader=>q[0], ExtUtils::MakeMaker=>q[6.42], Catalyst::Action::RenderView=>q[0], Catalyst::Plugin::Unicode=>q[0], Config::General=>q[0], Text::CSV_XS=>q[0], Catalyst::Helper::Model::DBIC::Schema=>q[0], Catalyst::Runtime=>q[5.80014] }
#     VERSION => q[0.01]
#     dist => { PREOP=>q[$(PERL) -I. "-MModule::Install::Admin" -e "dist_preop(q($(DISTVNAME)))"] }
#     realclean => { FILES=>q[MYMETA.yml] }
#     test => { TESTS=>q[t/01app.t t/02pod.t t/03podcoverage.t t/view_Web.t] }
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  ...
	  lib/Wardrobe/View/Web.pm $(INST_MAN3DIR)/Wardrobe::View::Web.$(MAN3EXT) 
...
TEST_FILE = test.pl
TEST_FILES = t/01app.t t/02pod.t t/03podcoverage.t t/view_Web.t
TESTDB_SW = -d
...
ppd :
	...
	$(NOECHO) $(ECHO) '        <DEPENDENCY NAME="Catalyst-Helper-Model-DBIC-Schema" VERSION="0,0,0,0" />' >> $(DISTNAME).ppd
	...
	$(NOECHO) $(ECHO) '        <DEPENDENCY NAME="Catalyst-Request-Upload" VERSION="0,0,0,0" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <DEPENDENCY NAME="Catalyst-Runtime" VERSION="5,80014,0,0" />' >> $(DISTNAME).ppd
...
pm_to_blib : $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')' -- \
	  ...
	  lib/Wardrobe/View/Web.pm blib/lib/Wardrobe/View/Web.pm 
...
catalyst_par :: all
	$(NOECHO) $(PERL) -Ilib -Minc::Module::Install -MModule::Install::Catalyst -e"Catalyst::Module::Install::_catalyst_par( '', 'Wardrobe', { CLASSES => [], CORE => 0, ENGINE => 'CGI', MULTIARCH => 0, SCRIPT => '', USAGE => q## } )"
